...
export default function OrphanageDetails() {
  ...
  // Utilizamos para conseguir capturar e usar os parâmetros passados para a nossa função 
  ...
  function handleOpenGoogleMapsRoutes() {
    ...
    // Em orphanage?.latitude o ? faz uma verificação de se o orfanato existe. Caso ele exista, pegue a propriedade
    // latitude dele.
  }
